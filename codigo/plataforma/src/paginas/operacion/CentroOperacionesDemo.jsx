...
export function CentroOperacionesDemo({ onNavegar }) {
  ...
  const pasos = [
    ...
    { titulo: 'Enviar invitaciones', detalle: `${enviados} de ${graduados.length} enviadas`, listo: graduados.length > 0 && enviados === graduados.length, icono: Mail, destino: 'gestion-graduados', accion: 'Enviar invitaciones', descripcion: 'Graduados que todavía deben recibir su acceso.' },
    ...
    { titulo: 'Enviar credenciales', detalle: `${credenciales}/${confirmados} enviadas`, listo: confirmados > 0 && credenciales === confirmados, icono: Mail, destino: 'gestion-graduados', accion: 'Enviar credenciales', descripcion: 'Credenciales listas para generar y enviar.' },
