...
import { Fonts, ThemeColor } from '@/constantes/tema';
import { useTheme } from '@/hooks/usar-tema';

export type TextoTematizadoProps = TextProps & {
  type?: 'default' | 'title' | 'small' | 'smallBold' | 'subtitle' | 'link' | 'linkPrimary' | 'code';
  themeColor?: ThemeColor;
};

export function TextoTematizado({ style, type = 'default', themeColor, ...rest }: TextoTematizadoProps) {
...
export { TextoTematizado as ThemedText };
