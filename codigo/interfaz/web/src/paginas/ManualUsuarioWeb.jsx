    ...
    >
      ...
      <header className="relative z-10 border-b border-white/5 bg-slate-900/60 backdrop-blur-md px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            onClick={onVolver}
            className="flex items-center justify-center h-10 w-10 rounded-full border border-white/10 bg-white/5 text-white/70 transition hover:bg-white/10 hover:text-white hover:scale-105 active:scale-95"
            title="Volver"
          >
            <ArrowLeft size={18} />
          </button>
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 w-full p-3 text-left rounded-xl transition-all duration-200 border ${
                      activa 
              ...
              <div className="bg-[#29ABE2]/5 border border-[#29ABE2]/20 p-5 rounded-xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                  <div className="bg-sky-500/10 border border-sky-500/30 rounded-lg p-2">
                    <div className="h-3 w-3 rounded-full bg-sky-500 mx-auto mb-1.5" />
          ...
          {tabActiva === 'porteria' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* Caso Verde */}
                <div className="border border-emerald-500/20 bg-emerald-950/20 p-5 rounded-2xl flex flex-col items-center text-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center justify-center shrink-0">
                    <CheckCircle2 size={22} />
                  </div>
                  <div>
                    <h4 className="text-xs font-black uppercase tracking-wider text-emerald-400">ACCESO PERMITIDO</h4>
                    <p className="text-[11px] text-emerald-100/60 leading-relaxed mt-2">
                ...
                {/* Caso Naranja */}
                <div className="border border-amber-500/20 bg-amber-950/20 p-5 rounded-2xl flex flex-col items-center text-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20 flex items-center justify-center shrink-0">
                    <AlertTriangle size={22} />
                  </div>
                  <div>
                    <h4 className="text-xs font-black uppercase tracking-wider text-amber-400">YA REGISTRADO</h4>
                ...
                {/* Caso Rojo */}
                <div className="border border-rose-500/20 bg-rose-950/20 p-5 rounded-2xl flex flex-col items-center text-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-rose-500/10 text-rose-400 border border-rose-500/20 flex items-center justify-center shrink-0">
                    <XCircle size={22} />
                  </div>
                  <div>
                    <h4 className="text-xs font-black uppercase tracking-wider text-rose-400">ACCESO DENEGADO</h4>
                    <p className="text-[11px] text-rose-100/60 leading-relaxed mt-2">
