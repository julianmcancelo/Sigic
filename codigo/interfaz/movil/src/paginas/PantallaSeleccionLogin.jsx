...
export function PantallaSeleccionLogin({ onSeleccionarAdmin, onSeleccionarEgresado }) {
  return (
    <LayoutAutenticacion>
      <div className="px-8 py-9">
        ...
        <p className="mb-8 text-xs text-[#90A4AE]">
          Seleccioná tu perfil para ingresar al sistema de gestión de invitados.
        </p>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[13px] font-black text-slate-800">Egresado</p>
              <p className="text-[11px] text-slate-400 font-medium">Carga y gestión de tus propios invitados</p>
            </div>
            <ChevronRight size={16} className="absolute right-4 text-slate-300 transition-transform group-hover:translate-x-1" />
          </button>
        </div>
