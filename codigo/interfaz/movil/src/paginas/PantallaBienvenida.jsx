...
import {
  ...
  ShieldCheck, ArrowRight, Cpu, MonitorPlay,
  Settings, LayoutGrid, BookOpen, ChevronRight, Wifi, WifiOff, FileImage, Calendar, UserCog,
} from 'lucide-react'
...
export function PantallaBienvenida({ usuario, onCerrarSesion, onNavegar }) {
  ...
  const accesos = esSuperAdmin
    ? [
        {
          icono: UserCog,
          titulo: 'Usuarios del Sistema',
          descripcion: 'Crear y administrar cuentas de administrativo, porteria y otros perfiles',
          pantalla: 'gestion-usuarios',
          badge: 'Super Admin',
        },
        {
          icono: ShieldCheck,
          titulo: 'Centro Super Administrador',
          descripcion: 'Pantalla exclusiva para funciones maestras de plataforma',
    ...
    : [
        {
          ...
          descripcion: 'Modulo de porteria: escaneo de QRs y check-in de invitados',
        ...
        },
        {
          ...
          descripcion: 'Alta de graduados, carga de invitados y listado general',
          pantalla: 'gestion-invitados',
        },
        {
          icono: QrCode,
          titulo: 'Codigos QR',
          descripcion: 'Generar y descargar QR de cada invitado',
          pantalla: 'gestion-invitados',
        },
        {
          icono: MapPin,
          titulo: 'Plano Anfiteatro',
          descripcion: 'Visualizacion y seleccion de ubicaciones en el plano',
        ...
        },
        {
          ...
          descripcion: 'Limites de invitados, datos del evento y control del portal',
          pantalla: 'ajustes',
          badge: 'Admin',
        },
        {
          icono: LayoutGrid,
          titulo: 'Gestion de Ceremonias',
          descripcion: 'Crear y administrar multiples eventos independientes',
          pantalla: 'gestion-ceremonias',
          badge: 'Habitats',
        },
        {
          icono: BookOpen,
          titulo: 'Catalogo de Profesores',
          descripcion: 'Registrar y administrar profesores para entregas de medallas',
