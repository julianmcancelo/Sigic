...
export function PantallaBienvenida({ usuario, onCerrarSesion, onNavegar }) {
  ...
  async function cargarDatos() {
    try {
      // 1. Stats
      const resStats = await fetch(`${BASE}/stats`)
  ...
  const accesos = [
    ...
    },
    {
      ...
      descripcion: 'Alta de egresados, carga de invitados y listado general',
    ...
    },
    {
      ...
      descripcion: 'Visualización y selección de ubicaciones en el plano',
            ...
            {cargandoStats ? (
              ...
              <>
                ...
                <StatCard
                  ...
                  descripcion="Entre todos los egresados"
                />
                <StatCard
                  icono={UserCheck}
                  etiqueta="Ingresados"
