...
router.post('/', async (req, res) => {
  const { nombre, fecha, lugar, max_invitados } = req.body;
  ...
  try {
    ...
    await db.query(
      'INSERT INTO ceremonias (id, nombre, fecha, lugar, max_invitados, activa) VALUES ($1, $2, $3, $4, $5, 0)',
      [id, nombre, fecha, lugar || 'Sede Beltrán', max_invitados || 4]
    );
